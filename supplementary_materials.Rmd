...
- Explanations of the different data cleaning steps goes here! 
...
```{r fig-s2, fig.cap="The naive Bayes AUC curve on the test dataset"}
...
```{r fig-s3, fig.cap = "Random Forest gain Curve on the test data"}
...
```{r fig-s4, fig.cap = "The AUC curve for the random forest regression model on the test dataset", warning=TRUE}
...
```{r fig-s5, fig.cap="The AUC curve for the random forest model on the full data set"}
