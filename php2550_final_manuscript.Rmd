...
```{r fig-one, echo=FALSE, dpi=300, out.width='86%', fig.align='center', fig.cap="The flow of the data cleaning process based on the specified isolate inclusion criteria."}
